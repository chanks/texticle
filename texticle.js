...
(function() {
  ...
  Texticle.parse_line = function(input) {
    var _j, _len1, _ref1;
    for (_j = 0, _len1 = regexes.length; _j < _len1; _j++) {
      _ref1 = regexes[_j], regex = _ref1[0], format = _ref1[1];
  ...
  Texticle.parse = function(input) {
    var heading, in_paragraph, index, line, lines, next_line, output, _j, _len1;
    output = "";
    in_paragraph = false;
